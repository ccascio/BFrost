...
export const newsWorker: WorkerManifest = {
  ...
  dashboard: {
    settings: [
      {
        id: 'news-digest-interests',
        label: 'News interests',
        description: 'Choose the topics searched through Google Custom Search when the digest runs.',
        tab: 'config',
        ...
        fields: [
          ...
          },
          {
            ...
            helpText: 'Each saved interest is searched with Google Custom Search when the digest runs.',
            seedPath: 'core.news.digestParams.queries',
          },
          {
            ...
            seedPath: 'core.news.digestParams.maxResultsPerQuery',
          },
          {
            ...
            seedPath: 'core.news.digestParams.maxLlmCandidates',
          },
          {
            ...
            seedPath: 'core.news.digestParams.maxTelegramItems',
          },
          {
            key: 'seenTtlHours',
            ...
            seedPath: 'core.news.digestParams.seenTtlHours',
          },
          {
            key: 'dateRestrict',
            label: 'Search window',
            ...
            seedPath: 'core.news.digestParams.dateRestrict',
          },
        ],
      },
      {
