...
export default function App() {
  ...
  function renderWorkerConfigurationSurface({
    ...
    if (worker.id === 'core.channels.telegram' && surface.id === 'telegram-credentials') {
      return <TelegramConnectPanel onSaved={() => void fetchDashboard(true)} />;
    }

    if (worker.id === 'core.channels.discord' && surface.id === 'discord-credentials') {
      return <DiscordConnectPanel onSaved={() => void fetchDashboard(true)} />;
    }
