...
- **Major**: wrong settings placement, missing low-code configuration fields, Item Bus misuse, package/local mismatch, missing permissions, or dashboard UX that blocks non-developers.
